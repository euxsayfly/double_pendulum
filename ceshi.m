...
L2=1;
g=9.8;
Da=inline(['[x(3);x(4);','inv([(m1+m2)*L1,m2*L2*cos(x(1)-x(2));','m1*L1*cos(x(1)-x(2)),m1*L2])*''[m2*L2*x(4)^2*sin(x(2)-x(1))-(m1+m2)*g*sin(x(1));','m2*L1*x(3)^2*sin(x(1)-x(2))-m2*g*sin(x(2))]]'],'t','x','flag','m1','m2','L1','L2','g');
